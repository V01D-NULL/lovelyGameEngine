...
namespace lovely {
    namespace GL {
        bool Shader::load_basic_shaders(GLuint program, const char *vertex_shader_src, const char *fragment_shader_src)
        {
            /*
            ...
            */
            lovely::logging::logger::info("Loading shader:", vertex_shader_src, NULL);
            ...
            else { lovely::logging::logger::err("Could not open the shader, thus the file cannot be parsed. (Perhaps double check your spelling?)"); }
            in_file.close();
